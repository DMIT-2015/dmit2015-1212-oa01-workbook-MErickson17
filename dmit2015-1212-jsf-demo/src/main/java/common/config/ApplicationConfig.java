...
@DataSourceDefinitions({
	...
	@DataSourceDefinition(
		...
		url="jdbc:sqlserver://DMIT-Capstone1.ad.sast.ca;databaseName=DMIT2015_1212_A01_merickson17;TrustServerCertificate=true",   // change A01 to E01 if you are in section E01, change yourNaitUsername
		user="merickson17",  //  change yourNaitUsername
		password="RemotePassword200488405"),    // Replace 200012345 with your NAIT StudentID
