...
public class EnforcementZoneCentreBatchlet extends AbstractBatchlet {
    ...
    private Logger _logger = Logger.getLogger(EnforcementZoneCentreBatchlet.class.getName()); // manually assign value to the logger
...
//        try (BufferedReader reader = new BufferedReader(new InputStreamReader(getClass().getResourceAsStream(_inputFile))))	{
            ...
            while ((line = reader.readLine()) != null) {
                ...
                Point geoLocation = (org.locationtech.jts.geom.Point) new WKTReader().read(wktText); // wkt - well known text
