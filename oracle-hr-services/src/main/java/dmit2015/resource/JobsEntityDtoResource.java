...
public class JobsEntityDtoResource {
    ...
    @Path("{id}")
    @GET    // This method only accepts HTTP GET requests.
    public Response findJobsEntityById(@PathParam("id") String jobsEntityId) {
    ...
    public Response updateJobsEntity(@PathParam("id") String jobsEntityId, JobsEntityDto dto) {
    ...
    @Path("{id}")    // This method accepts a path parameter and gives it a name of id
    public Response delete(@PathParam("id") String jobsEntityId) {
