 ...
 *
 ...
 curl -i -X DELETE http://localhost:8080/dmit2015-j1212-axrs-demo/webapi/TodoItems/4
...
public class TodoItemResource {
    ...
    public Response postTodoItem(@Valid TodoItem newTodoItem) {
        if (newTodoItem == null) {
            throw new BadRequestException(); // a 400 error
        }
        ...
        try {
            ...
            return Response
                    ...
                    .build(); // want to send back an internal server error - 500
        }
        ...
        return Response.created(todoItemsUri).build(); // This method gives more control of what the server returns; a 201
