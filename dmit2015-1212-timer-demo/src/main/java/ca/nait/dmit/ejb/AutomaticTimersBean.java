...
//         @Schedules({
//                 @Schedule(second = "0", minute ="50", hour = "11", dayOfWeek = "Mon,Wed", month = "Jan-Apr", year = "2022", info ="DMIT2015-OA01 Meeting", persistent = false),
...
//        @Schedule(second = "*", minute = "*", hour = "*", persistent = false) // make sure this is false so it doesn't pop up in another project!
