...
public class EmailSessionBean {
        ...
        @Resource(name = "java:jboss/mail/Default") // this can be found in the standalone.xml!
...
//                _defaultSession.getProperties().setProperty("mail.smtp.starttls.enable","true");
        ...
        @Asynchronous
        public void sendTextEmail(String mailToAddresses, String mailSubject, String mailBody) throws MessagingException { // send plain text
